...
namespace Spotted {
    ...
    public class PhotoAlbum {
        ...
        static Photo[] mBuiltInPhotos = {
            new Photo { mPhotoID = Resource.Drawable.imgBg,
                        mCaption = "Image Background" },
            new Photo { mPhotoID = Resource.Drawable.ic_action_refresh,
                        mCaption = "Refresh"},
            new Photo { mPhotoID = Resource.Drawable.ic_devices_black_24dp,
                        mCaption = "Devices"},
            new Photo { mPhotoID = Resource.Drawable.ic_action_attach,
                        mCaption = "Attach"},
            new Photo { mPhotoID = Resource.Drawable.ic_home_black_24dp,
                        mCaption = "Home"}
            };
